...
export const EntitiesDocument = gql`
  ...
  entities(
    filter: {not: {type: {startsWith: "asset"}}, or: [{and: [{relayerNode: {equalTo: $relayerNode}}, {entityVerified: {equalTo: true}}]}, {and: [{id: {equalTo: $relayerNode}}, {entityVerified: {equalTo: true}}]}, {and: [{entityVerified: {equalTo: false}}, {owner: {equalTo: $owner}}]}]}
  ) {
    nodes {
      id
      accordedRight
