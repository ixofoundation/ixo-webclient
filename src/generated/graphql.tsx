...
export type MessagesQuery = {
  ...
  messages?: {
    ...
    nodes: Array<{
      ...
      to?: string | null
      from?: string | null
      denoms?: Array<string | null> | null
      nodeId: string
      tokenNames?: Array<string | null> | null
 ...
 * });
 */
export function useGetAccountTokensQuery(
  baseOptions: Apollo.QueryHookOptions<GetAccountTokensQuery, GetAccountTokensQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetAccountTokensQuery, GetAccountTokensQueryVariables>(GetAccountTokensDocument, options)
}
export function useGetAccountTokensLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetAccountTokensQuery, GetAccountTokensQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
