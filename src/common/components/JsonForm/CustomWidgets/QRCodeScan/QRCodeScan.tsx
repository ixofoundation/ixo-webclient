...
const QRCodeScan: React.FunctionComponent<Props> = ({
  id,
  value,
  placeholder,
  onChange,
      ...
      <ExplainerText className="col-12 col-md-6">
        <div className="explainer-text-wrapper">
          <div className="explainer-text-item">
            <Phone fill="#000" />
            <div>
              <strong>Accept any permissions</strong> to use your device&apos;s
              camera
            </div>
          </div>
          <div className="explainer-text-item">
            <PhoneQR />
            <div>
              <strong>Scan</strong> the relevant QR code by{' '}
              <strong>placing the QR code over the camera</strong>
            </div>
          </div>
