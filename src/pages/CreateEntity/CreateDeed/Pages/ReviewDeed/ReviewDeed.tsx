...
const ReviewDeed: React.FC<Pick<RouteComponentProps, 'match'>> = ({ match }): JSX.Element => {
          ...
          <>
            <FlexBox direction='column' width='100%' gap={4}>
              <Typography variant='secondary'>
                This is the last step before creating this Deed on the ixo Blockchain.
              </Typography>
              <Typography variant='secondary'>
                <NavLink to={`${baseLink}/collection`}>Review the Deed details</NavLink> you have configured.
              </Typography>
              <Typography variant='secondary'>
