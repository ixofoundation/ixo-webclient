...
const MyStakeCharts: React.FC<Props> = ({ bondDid }) => {
        ...
        >
          <defs>
            <linearGradient id='color' x1='0.5' y1='0' x2='0.5' y2='1'>
              <stop offset='0%' stopColor={theme.ixoGreen} />
              <stop offset='100%' stopColor={theme.ixoLightGreen} />
            </linearGradient>
          </defs>
          <defs>
