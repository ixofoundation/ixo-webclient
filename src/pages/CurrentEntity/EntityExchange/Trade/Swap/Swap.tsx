        ...
        <div className='d-flex'>
          <AssetCardWrapper>
            {fromEntity && (
              <AssetCard
                id={'asset-card'}
                did={fromEntity.projectDid}
                name={fromEntity.data.name}
                logo={fromEntity.data.logo}
                image={fromEntity.data.image}
                sdgs={fromEntity.data.sdgs}
                description={fromEntity.data.description}
                dateCreated={moment(fromEntity.data.createdOn)}
                badges={[]}
                version={''}
          ...
          <AssetCardWrapper>
            {toEntity && (
              <AssetCard
                id={'asset-card'}
                did={toEntity.projectDid}
                name={toEntity.data.name}
                logo={toEntity.data.logo}
                image={toEntity.data.image}
                sdgs={toEntity.data.sdgs}
                description={toEntity.data.description}
                dateCreated={moment(toEntity.data.createdOn)}
                badges={[]}
                version={''}
                termsType={TermsOfUseType.PayPerUse}
                isExplorer={false}
