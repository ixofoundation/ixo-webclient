...
import { CreateEntityPageContentState } from '../createEntityPageContent/createEntityPageContent.types'
import { CreateEntityAttestationState } from '../createEntityAttestation/createEntityAttestation.types'
import { CreateEntitySettingsState } from '../createEntitySettings/createEntitySettings.types'
import { CreateEntityClaimsState } from '../createEntityClaims/createEntityClaims.types'
  ...
  state = {
    ...
    createEntityPageContent: {
      header: {
        ...
        brand: 'Some Brand',
        location: 'AR',
        headerFileSrc: 'https://pds_pandora.ixo.world/public/sbujb0xg0dgkeljwtnc',
    ...
    createEntityAttestation: {
      ...
      questions: {
        '00000001-3b7d-4bad-9bdd-2b0d7b3dcb67': {
          ...
          label: 'Rate the below from 1 to 10 with 1 bring terrible and 10 being excellent',
        ...
        '00000011-3b7d-4bad-9bdd-2b0d7b3dcb67': {
          ...
          maxItems: 2,
          control: 'checkboxes',
          itemValues: ['Option1', 'Option2', 'Option3', 'Option4', 'Option5', 'Option6', 'Option7'],
          itemLabels: ['Option 1', 'Option 2', 'Option 3', 'Option 4', 'Option 5', 'Option 6', 'Option 7'],
          order: 11,
        },
    ...
    createEntitySettings: {
      ...
      filters: {
        'Project Type': ['Index', 'Accreditation', 'Accountability', 'Insurance Bond'],
        SDG: [
...
describe('CreateEntity Selectors', () => {
              ...
              properties: {
                '00000011-3b7d-4bad-9bdd-2b0d7b3dcb67': {
                  ...
                  items: {
                    ...
                    enumNames: ['Option 1', 'Option 2', 'Option 3', 'Option 4', 'Option 5', 'Option 6', 'Option 7'],
                  },
                  uniqueItems: true,
                  minItems: 1,
                  maxItems: 2,
  ...
  describe('selectEntityApiPayload', () => {
    it('should return the payload for the entity', () => {
      ...
      const projectResult = SUT.selectEntityApiPayload(EntityType.Project, 'somepageid')(state)
