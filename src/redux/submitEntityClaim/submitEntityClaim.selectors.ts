...
export const selectQuestions = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
  return submitEntityClaim ? submitEntityClaim.questions : null
})

export const selectCurrentQuestionNo = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
...
export const selectCurrentQuestion = createSelector(
  ...
  (questions, currentQuestionNo) => {
    return questions && questions.length > 0 ? questions[currentQuestionNo! - 1] : null
  },
)

export const selectQuestionCount = createSelector(selectQuestions, (questions) => {
  return questions ? questions.length : null
})

export const selectAnswers = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
  return submitEntityClaim ? submitEntityClaim.answers : null
})

export const selectCurrentAnswer = createSelector(selectCurrentQuestion, selectAnswers, (question, answers) => {
...
export const selectClaimType = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
  return submitEntityClaim ? submitEntityClaim.type : null
})

export const selectTemplateDid = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
  return submitEntityClaim ? submitEntityClaim.templateDid : null
})

export const selectClaimTitle = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
  return submitEntityClaim ? submitEntityClaim.claimTitle : null
})

export const selectClaimShortDescription = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
  return submitEntityClaim ? submitEntityClaim.claimShortDescription : null
})

export const selectSavingAnswer = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
  return submitEntityClaim ? submitEntityClaim.savingAnswer : null
})

export const selectAnswersComplete = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
  return submitEntityClaim ? submitEntityClaim.answersComplete : null
})

export const selectCreating = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
  return submitEntityClaim ? submitEntityClaim.creating : null
})

export const selectCreated = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
  return submitEntityClaim ? submitEntityClaim.created : null
})

export const selectError = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
  return submitEntityClaim ? submitEntityClaim.error : null
})

export const selectIsLoading = createSelector(selectSubmitEntityClaim, (submitEntityClaim) => {
  ...
  (templateDid, type, userDid, entityDid, questions, answers): ApiClaim => {
    return {
      ...
      items: Object.keys(answers!).map((id) => {
        return {
          id,
          attribute: questions!.find((question) => question.schema.properties![id])!['@type'],
          value: answers![id],
        }
      }),
