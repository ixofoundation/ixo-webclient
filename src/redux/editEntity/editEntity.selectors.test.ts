...
import { EditEntityClaimsState } from '../editEntityClaims/editEntityClaims.types'
...
describe('EditEntity Selectors', () => {
  describe('selectEditEntity', () => {
    it('should return the editEntity property of root state', () => {
      // when ... we call the selector
      const result = SUT.selectEditEntity(state)

      // then ... should return result as expected
      expect(result).toEqual(state.editEntity)
    })
  })
