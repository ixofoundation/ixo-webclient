...
function getJSONRequestHeaders(
  ...
  let requestHeaders: Dictionary<string> = {
...
export function fetchGetJSON<T>(
  url: string,
  extraHeaders?: Dictionary<string>,
): Promise<T> {
  return fetch(url, {
...
export function sendDeleteRequest<T>(
  url: string,
  extraHeaders?: Dictionary<string>,
): Promise<T> {
  return fetch(url, {
...
export function sendPostJSON<T>(
  url: string,
  body: Dictionary<any>,
  extraHeaders?: Dictionary<string>,
): Promise<T> {
