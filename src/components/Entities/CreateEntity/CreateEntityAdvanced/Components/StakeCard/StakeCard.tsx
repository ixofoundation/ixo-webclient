...
import { PaymentDenomination, StakeType, SlashingCondition } from '../../../../../../types/entities'
import { paymentDenominationMap, stakeTypeMap, slashingConditionMap } from '../../../../../../types/entities.map'
