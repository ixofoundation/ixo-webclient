...
class TransactionsTable extends Component<any> {
  ...
  resizeTable() {
    const content = document.getElementsByClassName('AppBody_panel__content')
  ...
  render() {
    return (
      <div className="AppBody_panel__chrome Table">
        <div className="AppBody_panel__content" style={{ minHeight: '60vh' }}>
