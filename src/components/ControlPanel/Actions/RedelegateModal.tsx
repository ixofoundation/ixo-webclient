  ...
  return (
    <Container>
      <form onSubmit={handleSubmit}>
        ...
        <InputText type='text' id='validatorSrcAddress' formStyle={FormStyles.modal} text='Validator Src Address' />
        <InputText type='text' id='validatorDstAddress' formStyle={FormStyles.modal} text='Validator Dst Address' />
        <ButtonContainer>
