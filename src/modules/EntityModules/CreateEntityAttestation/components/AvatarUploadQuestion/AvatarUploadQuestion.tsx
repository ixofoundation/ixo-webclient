...
const AvatarUploadQuestion: React.FunctionComponent<Props> = React.forwardRef(
  (
    {
      title,
      description,
    ...
    const uiSchema = {
      ...
      label: {
        'ui:widget': 'text',
        'ui:placeholder': 'The label for the avatar upload selector',
      },
      description: {
        'ui:widget': 'textarea',
        'ui:placeholder':
...
export default AvatarUploadQuestion
