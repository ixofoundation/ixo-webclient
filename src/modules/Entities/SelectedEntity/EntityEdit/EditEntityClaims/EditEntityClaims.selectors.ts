...
import { EditEntityClaimsState, EntityClaimItem } from './types'
import { RootState } from 'common/redux/types'

export const selectEntityClaimsState = (
  state: RootState,
): EditEntityClaimsState => state.editEntityClaims

export const selectEntityClaims = createSelector(
  selectEntityClaimsState,
  (entityClaimsState: EditEntityClaimsState): EntityClaimItem[] => {
