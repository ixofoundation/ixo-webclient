import { EditEntityTemplateState, EditEntityTemplateActions, EditEntityTemplateActionTypes } from './types'
...
export const reducer = (state = initialState, action: EditEntityTemplateActionTypes): EditEntityTemplateState => {
  switch (action.type) {
