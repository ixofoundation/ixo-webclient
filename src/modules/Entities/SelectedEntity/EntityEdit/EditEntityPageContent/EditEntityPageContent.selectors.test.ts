import * as SUT from './EditEntityPageContent.selectors'
...
describe('EditEntityPageContent Selectors', () => {
  describe('selectPageContent', () => {
    it('should return the editEntityPageContent property of root state', () => {
      // when ... we call the selector
      const result = SUT.selectPageContent(state)

      // then ... should return result as expected
      expect(result).toEqual(state.editEntityPageContent)
    })
  })
