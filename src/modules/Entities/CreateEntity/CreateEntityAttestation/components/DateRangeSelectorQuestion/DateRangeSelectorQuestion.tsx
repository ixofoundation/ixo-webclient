...
const DateRangeSelectorQuestion: React.FunctionComponent<Props> = React.forwardRef(
...
DateRangeSelectorQuestion.displayName = 'DateRangeSelectorQuestion'

export default DateRangeSelectorQuestion
