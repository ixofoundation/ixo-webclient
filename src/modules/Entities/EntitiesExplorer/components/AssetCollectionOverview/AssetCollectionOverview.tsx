...
const AssetCollectionOverview: React.FC<Props> = ({ collection, handleBack }): JSX.Element => {
  ...
  const renderContext = (): JSX.Element => (
    <AssetCollectionOverviewContext className='d-flex flex-column'>
      <AssetCollectionOverviewText className='mb-2'>{collection.description}</AssetCollectionOverviewText>

      <AssetCollectionOverviewText>Creator: {collection.creator}</AssetCollectionOverviewText>
      <AssetCollectionOverviewText>Minted: {collection.minted}</AssetCollectionOverviewText>
    </AssetCollectionOverviewContext>
  )
      ...
      <ul>
        ...
        <li>
          <AssetCollectionOverviewText fontWeight={600}>
            ${displayTokenAmount(collection.highestPrice, 2)} / ${displayTokenAmount(collection.lowestPrice, 2)}
          </AssetCollectionOverviewText>
    ...
    <AssetCollectionOverviewAttributes className='d-flex flex-column'>
      <ul>
        <li>
          ...
          <AssetCollectionOverviewText fontWeight={600}>{collection.location}</AssetCollectionOverviewText>
        </li>
        <li>
        ...
        <li>
          ...
          <AssetCollectionOverviewText fontWeight={600}>{collection.model}</AssetCollectionOverviewText>
        </li>
        <li>
  ...
  const renderCollectionDetail = (): JSX.Element => (
    <DetailBox>
      <DetailBoxText>
        <Typography fontWeight={700} fontSize='24px' lineHeight='28px' color='#000000'>
          {collection.title}
        </Typography>
        <Typography fontWeight={400} fontSize='13px' lineHeight='15px' color='#828E94'>
          {collection.subTitle}
        </Typography>
      </DetailBoxText>
  ...
  return (
    <AssetCollectionOverviewWrapper>
      <AssetCollectionOverviewRow className='row position-relative mb-4 d-flex justify-content-between'>
        <AssetCollectionOverviewCol className='col-3'>{renderCollectionDetail()}</AssetCollectionOverviewCol>
        <AssetCollectionOverviewCol className='col-3 d-flex justify-content-end'>
          <Button variant='secondary' onClick={handleBack}>
            <IconArrowLeft />
            <Typography fontWeight={600} fontSize='16px' lineHeight='unset' color='#000'>
              Back
            </Typography>
          </Button>
        </AssetCollectionOverviewCol>
      ...
      <AssetCollectionOverviewRow className='row position-relative mb-4'>
        <AssetCollectionOverviewCol className='col-12 d-flex' style={{ gap: 20 }}>
