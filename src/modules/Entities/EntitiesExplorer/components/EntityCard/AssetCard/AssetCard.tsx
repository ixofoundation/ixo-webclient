...
const DataCard: React.FunctionComponent<Props> = ({
  ...
  const normalValue = new BigNumber(TotalSupply).dividedBy(new BigNumber(10).pow(6)).toFixed(0).toString()
  ...
  return (
    ...
    >
      ...
      >
        ...
        <CardBottom style={{ color: 'black', height: '246px' }}>
          <div className='row'>
          ...
          <div className='d-flex align-items-center justify-content-between'>
            <div>
              <div style={{ color: '#01283B', fontSize: 16, fontWeight: 400 }}>Total Supply</div>
