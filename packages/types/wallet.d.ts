...
export declare type WalletClient = Pick<Keplr, 'enable' | 'getOfflineSigner' | 'getOfflineSignerAuto' | 'getOfflineSignerOnlyAmino'> & Partial<Pick<Keplr, 'mode' | 'experimentalSuggestChain'>> & {
...
export interface Wallet {
    ...
    description: string;
    imageUrl: string;
    getClient: (chainInfo: ChainInfo, walletConnect?: WalletConnect, options?: Record<string, any>) => Promise<WalletClient | undefined>;
