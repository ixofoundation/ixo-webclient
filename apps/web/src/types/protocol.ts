...
import { ReactComponent as UserIcon } from '/public/assets/images/icon-user.svg'
import { ReactComponent as UserCircleIcon } from '/public/assets/images/icon-user-circle.svg'
import { ReactComponent as TagsIcon } from '/public/assets/images/icon-tag.svg'
import { ReactComponent as PageIcon } from '/public/assets/images/icon-laptop.svg'
import { ReactComponent as PaymentIcon } from '/public/assets/images/icon-payment.svg'
import { ReactComponent as ImageIcon } from '/public/assets/images/icon-image-outline.svg'
import { ReactComponent as TextIcon } from '/public/assets/images/icon-text.svg'
import { ReactComponent as DatabaseIcon } from '/public/assets/images/icon-database.svg'
import { ReactComponent as CredentialIcon } from '/public/assets/images/icon-credential.svg'
import { ReactComponent as AuthorisationIcon } from '/public/assets/images/icon-authorisation.svg'
import { ReactComponent as GlobeIcon } from '/public/assets/images/icon-globe.svg'
import { ReactComponent as AlgorithmIcon } from '/public/assets/images/icon-algorithm.svg'
import { ReactComponent as SmartContractIcon } from '/public/assets/images/icon-smart-contract.svg'
import { ReactComponent as ClaimIcon } from '/public/assets/images/icon-claim.svg'
import { ReactComponent as DashboardIcon } from '/public/assets/images/icon-dashboard.svg'
import { ReactComponent as DocumentIcon } from '/public/assets/images/icon-document.svg'
import { ReactComponent as AgentAuthorisationIcon } from '/public/assets/images/icon-agent-autorisation.svg'
import { ReactComponent as AgentCapabilityIcon } from '/public/assets/images/icon-agent-capability.svg'
import { ReactComponent as AgentUsageLicenseIcon } from '/public/assets/images/icon-usage-license.svg'
import { ReactComponent as ProjectIcon } from '/public/assets/images/icon-project.svg'
import { ReactComponent as AlphaBondIcon } from '/public/assets/images/icon-alphabond.svg'
import { ReactComponent as LBPIcon } from '/public/assets/images/icon-lbp.svg'
import { ReactComponent as QuadraticIcon } from '/public/assets/images/icon-quadratic.svg'
import { ReactComponent as ConvertibleIcon } from '/public/assets/images/icon-convertible.svg'
import { ReactComponent as ClaimSchemaStoreIcon } from '/public/assets/images/icon-claim-schema-store.svg'
import { ReactComponent as PublicDataNodeIcon } from '/public/assets/images/icon-public-data-node.svg'
import { ReactComponent as ChainServicesIcon } from '/public/assets/images/icon-chain-services.svg'
import { ReactComponent as Web2ServicesIcon } from '/public/assets/images/icon-web2-services.svg'
import { ReactComponent as OracleServicesIcon } from '/public/assets/images/icon-oracle-services.svg'
import { ReactComponent as DataSourceIcon } from '/public/assets/images/icon-data-source.svg'
import { ReactComponent as VerifiableDisplaySourceIcon } from '/public/assets/images/icon-verifiable-display-source.svg'
import { ReactComponent as AuthenticationSourceIcon } from '/public/assets/images/icon-authentication-source.svg'
import { ReactComponent as WebKeyManagementIcon } from '/public/assets/images/icon-web-key-management.svg'
import { ReactComponent as SmartContract2Icon } from '/public/assets/images/icon-smart-contract2.svg'
import { ReactComponent as JamboDAppIcon } from '/public/assets/images/icon-jambo-dapp.svg'
import { ReactComponent as MatrixServerIcon } from '/public/assets/images/icon-matrix-server.svg'
import { ReactComponent as EvaluationMethodologyIcon } from '/public/assets/images/icon-evaluation-methodology.svg'
import { ReactComponent as HandshakeIcon } from '/public/assets/images/icon-handshake.svg'
import { ReactComponent as StakingIcon } from '/public/assets/images/icon-staking.svg'
...
import { ReactComponent as TreasuryIcon } from '/public/assets/images/icon-treasury.svg'
import { ReactComponent as DatabaseMultiIcon } from '/public/assets/images/icon-coins-solid.svg'
...
import { ReactComponent as CycleIcon } from '/public/assets/images/icon-cycle.svg'
import { ReactComponent as ArrowUpIcon } from '/public/assets/images/icon-arrow-up.svg'
import { ReactComponent as AuthGrantIcon } from '/public/assets/images/icon-auth-grant.svg'
import { ReactComponent as MemberGroupIcon } from '/public/assets/images/icon-member-group.svg'
...
import { ReactComponent as AnnouncementIcon } from '/public/assets/images/icon-announcement.svg'
import { ReactComponent as PaperIcon } from '/public/assets/images/icon-paper2.svg'
import { ReactComponent as ProposalIcon } from '/public/assets/images/icon-proposal.svg'
import { ReactComponent as SmartContract3Icon } from '/public/assets/images/icon-smart-contract3.svg'
import { ReactComponent as SmartContract4Icon } from '/public/assets/images/icon-smart-contract4.svg'
import { ReactComponent as ProfileIcon } from '/public/assets/images/icon-profile.svg'
import { ReactComponent as GearMultiIcon } from '/public/assets/images/icon-gear-multi.svg'
import { ReactComponent as Plus2Icon } from '/public/assets/images/icon-plus2.svg'
import { ReactComponent as CodeIcon } from '/public/assets/images/icon-code-solid.svg'
import { ReactComponent as BoxOpenSolidIcon } from '/public/assets/images/icon-box-open-solid.svg'
import { ReactComponent as SlidersHSolidIcon } from '/public/assets/images/icon-sliders-h-solid.svg'
import { ReactComponent as VoteYeaIcon } from '/public/assets/images/icon-vote-yea-solid.svg'
import { ReactComponent as VolumeUpIcon } from '/public/assets/images/icon-volume-up-solid.svg'
import { ReactComponent as LinkedAccountIcon } from '/public/assets/images/icon-linked-account.svg'
import { ReactComponent as UserPlusIcon } from '/public/assets/images/icon-user-plus-solid.svg'
