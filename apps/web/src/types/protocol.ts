...
import EvaluationMethodologyIcon from 'assets/images/icon-evaluation-methodology.svg'
...
import LockOpenIcon from 'assets/images/icon-lock-open-solid.svg'
...
import UserPlusIcon from 'assets/images/icon-user-plus-solid.svg'
