...
import EvaluationMethodologyIcon from '/public/assets/images/icon-evaluation-methodology.svg'
...
import LockOpenIcon from '/public/assets/images/icon-lock-open-solid.svg'
...
import UserPlusIcon from '/public/assets/images/icon-user-plus-solid.svg'
