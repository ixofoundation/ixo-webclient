...
import { TCreateEntityState, TCreateEntityModel } from './createEntityAsAction.types'
...
export const selectCreateEntity = (state: RootState): TCreateEntityState => state.newEntityAsAction
