...
export const blockExplorerAccountEndpoint = getBlockExplorerAccountEndpoint(
  activeExplorer as keyof typeof blockExplorersAccounts,
)
export const blockExplorerTransactionEndpoint = getBlockExplorerTransactionEndpoint(
  activeExplorer as keyof typeof blockExplorersTransactions,
)
