import { BlockFromConfig, BlockNoteEditor, FileBlockConfig, PropSchema, Props, createBlockSpec } from "@blocknote/core";
...
export const imageRender = (
  ...
  if (block.props.url === "") {
    ...
    editor.resolveFileUrl(block.props.url).then((downloadUrl: string) => {
...
export const imageToExternalHTML = (
  ...
  if (!block.props.url) {
    ...
    div.textContent = "Add Hero Image";
