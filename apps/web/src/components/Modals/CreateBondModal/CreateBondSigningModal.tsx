...
import AlphabondIcon from 'assets/images/alpha-icon.svg?url'
import RingIcon from 'assets/images/ring.svg?url'
...
const CreateBondSigningModal: React.FunctionComponent<Props> = ({ alphaBondInfo }) => {
...
export default CreateBondSigningModal
