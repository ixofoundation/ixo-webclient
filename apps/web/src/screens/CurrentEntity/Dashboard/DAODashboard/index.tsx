...
import CreateEntityLayout from 'screens/CreateEntity/CreateEntityLayout/CreateEntityLayout'
...
const DAODashboard: React.FC = (): JSX.Element => {
  ...
  const routes: Path[] = [
    ...
    //   icon: '/public/assets/img/sidebar/global.svg',
    //   sdg: 'Navigator',
    //   tooltip: 'Navigator',
    //   strict: true,
    // },
    ...
    },
    {
      ...
      icon: '/public/assets/img/sidebar/governance.svg',
      sdg: 'Governance',
      tooltip: 'Governance',
    },
    {
      url: `/entity/${entityId}/dashboard/my-participation` + (selectedGroup ? '?' + searchParams.toString() : ''),
      icon: '/public/assets/img/sidebar/profile.svg',
    ...
    },
    {
      ...
      icon: '/public/assets/img/sidebar/agent.svg',
      sdg: 'Agents',
      tooltip: 'Agents',
    ...
    },
    {
      ...
      icon: '/public/assets/img/sidebar/gear.svg',
      sdg: 'Edit Entity',
      tooltip: 'Edit Entity',
      disabled: !registered || owner !== address,
    },
