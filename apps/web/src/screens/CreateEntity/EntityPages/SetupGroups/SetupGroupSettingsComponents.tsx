...
export const RenderGroupIdentity = ({ data, setData, isLedgeredGroup }: RenderGroupIdentityProps): JSX.Element => {
  ...
  return (
    <CardWrapper direction='column' gap={5} mb={7}>
...
export const GroupMemberships = ({ setData, data, isLedgeredGroup }: RenderGroupIdentityProps): JSX.Element => {
  ...
  return (
    <Flex direction='column' w='100%' gap={7} mb={7}>
        ...
        <CardWrapper direction='column' gap={5} key={membershipIdx}>
          <Flex justify='space-between' align='center'>
            ...
            <Flex gap={4}>
              ...
              />
              <Button variant='primary' size='custom' w={52} height={48} onClick={handleImportCsv(membershipIdx)}>
                <Image src={IconFileUploadSolid} alt='FileUpload' width={5} height={5} color={theme.colors.blue[5]} />
              </Button>
              <Button
                variant='grey900'
                size='custom'
      ...
      <CardWrapper className='cursor-pointer' w='100%' align='center' gap={2} onClick={handleAddMembership}>
    ...
    <Flex direction='column' w='100%' gap={7} mb={7}>
      ...
      {!useExistingToken ? (
        <>
          ...
          <CardWrapper className='cursor-pointer' w='100%' align='center' gap={2} mb={7} onClick={handleAddMembership}>
            <Image src={IconPlus} alt='Plus' width={5} height={5} color={theme.colors.blue[5]} />
            <Typography color='blue' size='xl' weight='medium'>
              Add a Distribution Category
            </Typography>
